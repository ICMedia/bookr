...
SECRET_KEY = 'w$*#hqj8adbdg8-r184y=^d$3*ul#q#en5%km@zv@)8&0sckc1'
...
REST_FRAMEWORK = {
    ...
    'DEFAULT_PAGINATION_CLASS': 'api.PageNumberPagination',
    'PAGE_SIZE': 20,
}
...
if os.environ.get('MODE', 'development') == 'PRODUCTION':
    ...
    DATABASES['default']['NAME'] = os.environ['DATABASE_DB']
